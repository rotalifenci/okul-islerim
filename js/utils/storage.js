...
window.StorageManager = {
    ...
    // Verileri yükle veya ilk veri setiyle başlat
    loadData() {
        try {
    ...
    exportJSON(data) {
        ...
        a.download = `rotali-fenci-yedek-${dateStr}.json`;
    ...
    resetToDefaults() {
        if (confirm("DİKKAT: Mevcut tüm veriler sıfırlanacak ve başlangıç durumuna dönülecektir. Devam etmek istiyor musunuz?")) {
